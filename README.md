...
/
├── 📁 image/              # Visual assets used in the theme
├── 📄 manifest.json       # Theme declaration & configuration
├── 📄 Cached Theme.pak     # Packaged Chrome theme data
├── 📄 LICENSE             # MIT License
└── 📄 README.md           # This file
...
✔️ Custom colors inspired by **IUB portal branding**  
✔️ Elegant combination of **dark blue, white, and gold**  
✔️ Designed for comfort during academic browsing  
✔️ MIT Licensed — free to modify and distribute
...
- 🎨 Improving theme visuals
- 📦 Adding alternate color variants
...
**Adeeb Technology Lab** — Digital Tech Experts  
🌐 https://www.adeebtechlab.com/ 
📩 AdeebTechnologyLab@gmail.com

---
Enjoy your personalized Chrome experience! ✨
